...
import { fetchOrderHistory } from '../services/api'; // Removed getAuthToken import
...
const OrderHistory = ({ navigate }) => {
  ...
  useEffect(() => {
    const getOrders = async () => {
      ...
      setError(null);
      try {
        // Removed token check and navigation based on token
        ...
        // Call fetchOrderHistory without token
    ...
    getOrders();
  }, [navigate]); // navigate is a dependency, keep it
